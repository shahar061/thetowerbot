...
export type StrategyDefinition = {
  id: string; name: string; version: number; source_template: string; builtin: boolean;
...
export type StrategyAssignment = { account_id: string; strategy_id: string; strategy_version: number; strategy_name: string;
  baseline: BuildRouteDocument["baseline"] };
export type SaveStrategyInput = { name: string; source_template: string; baseline: BuildRouteDocument["baseline"]; strategy_id?: string };
